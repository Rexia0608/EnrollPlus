    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [
          ...
          axios.get(`${API_URL}/admin/enrollmentTrend`),
          axios.get(`${API_URL}/admin/incomeOverview`),
          axios.get(`${API_URL}/admin/paymentProgress`),
          axios.get(`${API_URL}/admin/enrollmentFunnel`),
          axios.get(`${API_URL}/admin/topCourses`),
        ]);
