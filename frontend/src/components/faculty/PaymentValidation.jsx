...
const getProofUrl = (filename) => {
  ...
  return `${API_URL}/faculty/review-proof-of-payment/${clean}`;
};
...
function PaymentValidation() {
  ...
  const fetchPaymentQueue = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_URL}/faculty/queue-proof-of-payment-review`,
      );
  ...
  const handleValidate = async (
    ...
    try {
      const response = await axios.patch(
        `${API_URL}/faculty/verified-payment`,
        fileData,
      );
  ...
  const handleExcuseLetter = async (approved) => {
    ...
    try {
      const response = await axios.patch(
        `${API_URL}/faculty/handle-excuse-letter`,
        fileData,
      );
      toast.success(response.data.message);
      setFeedback("");
