    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [enrollmentStatusRes, enrollmentCheckRes, coursesRes] =
          await Promise.all([
            axios.get(`${API_URL}/student/enrollment-open-status`, headers),
            axios.get(
              `${API_URL}/student/validate-enrolled-student/${user.id}`,
              headers,
            ),
            axios.get(`${API_URL}/student/course-list`, headers),
          ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const [enrollmentResultRes, enrollmentCheckResult] = await Promise.all([
        axios.post(
          `${API_URL}/student/enrollment-upload-documents-process`,
          submitFormData,
          headers,
        ),
        axios.get(
