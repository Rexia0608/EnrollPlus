...
const API_URL_MAINTENANCE = `${API_URL}/admin/maintenance`;
...
function MaintenanceModeCard() {
  ...
  const fetchMaintenanceStatus = async () => {
    try {
      const response = await axios.get(API_URL_MAINTENANCE);
  ...
  const updateMaintenanceStatus = async (mode, message) => {
    ...
    try {
      const response = await axios.put(API_URL_MAINTENANCE, {
