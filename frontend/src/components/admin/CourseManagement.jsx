...
function CourseManagement() {
  ...
  const handleConfirmDelete = async () => {
    if (courseToDelete) {
      try {
        await axios.delete(
          `${API_URL}/admin/deleteCourse/${courseToDelete.id}`,
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (currentCourse) {
        ...
        await axios.put(
          `${API_URL}/admin/editCourse/${currentCourse.id}`,
          serverData,
        );
        toast.success("Course updated successfully");
      } else {
        // Create new course
        await axios.post(`${API_URL}/admin/addCourse`, serverData);
        toast.success("Course added successfully");
      }

      // Reload courses from DB and map them
      const res = await axios.get(`${API_URL}/admin/courseList`);
