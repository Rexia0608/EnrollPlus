...
export default function EnrollmentControl() {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(
        `${API_URL}/admin/updateSemesterYear/${formData.id}`,
        {
          year_series: formData.academicYear,
          semester: formData.semester,
          start_date: formData.startDate,
  ...
  const confirmOpenEnrollment = async () => {
    ...
    try {
      await axios.patch(
        `${API_URL}/admin/switchStatusAcademicYear/${selectedYear.id}`,
        {
  ...
  const confirmClassStatusChange = async () => {
    ...
    try {
      const response = await axios.patch(
        `${API_URL}/admin/switchClassStatusAcademicYear/${selectedYear.id}`,
        {
  ...
  const toggleEnrollment = async (year) => {
    ...
    try {
      await axios.patch(
        `${API_URL}/admin/switchStatusAcademicYear/${year.id}`,
